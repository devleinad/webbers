...
<div class="container">
    <div class="row main-row">
        ...
        <div class="col-lg-lg-7 col-md-7">
            <form method="POST" action="{{route('questions.store')}}" id="askForm">
                @csrf
                <div class="form-group">
                    <label class="label">Title of your question/post <i>(Be concise about your title)</i></label>
                    <input type="text" name="post_title"
                    class="form-control form-control-sm @error('post_title') is-invalid @enderror" value="{{old('post_title')}}"
                ...
                <div class="form-group">
                    ...
                    <textarea name="post_content" class="@error('post_content') is-invalid @enderror" id="post_content"></textarea>
                    @error('post_content')
                    <small class="text-danger">{{$message}}</small>
                    @enderror
                </div>
